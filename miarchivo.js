...
const escribir = (respuestaCorrecta) =>{
  ...
  puntosAcum.innerHTML= "Puntos acumulados" +"<br></br>"+total
...
const pais1 = new paisesDatos ("Argentina", "Buenos Aires", 47327407, "<img src=/imagenesmapa/argentina-5323216.svg height=150 alt=mapa >", "<img src=/imagenesBanderas/argentina-162229.svg width=100 alt=bandera>");
...
const pais5 = new paisesDatos ("Alemania", "Berlin", 83811678,"<img src=/imagenesmapa/germany-890238.svg width=150 alt=mapa>", "<img src=/imagenesBanderas/germany-31017.svg width=100 alt=bandera>");
...
const pais16 = new paisesDatos ("Brasil", "Brasilia", 210385000,"<img src=/imagenesmapa/brazil-881119.svg width=150 alt=mapa>", "<img src=/imagenesBanderas/brazil-305531.svg width=100 alt=bandera>");
...
restot.innerHTML= "<h2 class=restotal>El total de puntos acumulados es "+ total +"</h2><p class=resTexto >Aprendiste sobre los siguientes paises =" + x +  "</p>" +usuarioActual.nombre+ " "+usuarioActual.apellido+" de "+usuarioActual.pais+ " de "+usuarioActual.edad+ " años"+"<div id=categoria></div>";
  ...
  preguntas.forEach(function(pregunta) {
    pregunta.addEventListener('click', function(e) {
      if (e.target.tagName === 'BUTTON') {
        ...
        var buttons = pregunta.querySelectorAll('button');
